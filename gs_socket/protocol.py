class BaseProtocol:
    MSG_TAG_SIZE = 5
    MSG_START_TAG = "<"*MSG_TAG_SIZE
    MSG_END_TAG = ">"*MSG_TAG_SIZE
    ...
    def create_msg(cls, data, msg_type=None):
        ...
        """
        msg_data = "DATA:{0}".format(data)
        msg_data_len = "DATA LENGTH:{0}".format(cls.weight_msg(msg_data))
        msg_type = "TYPE:{0}".format(msg_type)
        return cls.MSG_START_TAG + ";".join([msg_type, msg_data_len, msg_data]) + cls.MSG_END_TAG